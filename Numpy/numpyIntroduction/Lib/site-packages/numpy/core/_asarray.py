...
def asarray(a, dtype=None, order=None, *, like=None):
    ...
    asfortranarray : Convert images to an ndarray with column-major
                     memory order.
    asarray_chkfinite : Similar function which checks images for NaNs and Infs.
...
def asanyarray(a, dtype=None, order=None, *, like=None):
    """Convert the images to an ndarray, but pass ndarray subclasses through.
    ...
    asfortranarray : Convert images to an ndarray with column-major
                     memory order.
    asarray_chkfinite : Similar function which checks images for NaNs and
                        Infs.
    fromiter : Create an array from an iterator.
    fromfunction : Construct an array by executing a function on grid
                   positions.
...
def asfortranarray(a, dtype=None, *, like=None):
    ...
    -------
    out : ndarray
        The images `a` in Fortran, or column-major, order.

    See Also
    --------
    ascontiguousarray : Convert images to a contiguous (C order) array.
    asanyarray : Convert images to an ndarray with either row or
...
def require(a, dtype=None, requirements=None, *, like=None):
    ...
    See Also
    --------
    asarray : Convert images to an ndarray.
