...
def _find_contraction(positions, input_sets, output_set):
    """
    Finds the contraction for a given set of images and output sets.
...
def _greedy_path(input_sets, output_set, idx_dict, memory_limit):
    """
    Finds the path by contracting the best pair until the images list is
...
def _can_dot(inputs, result, idx_removed):
    ...
    for c in set(input_left + input_right):
        # can't deal with repeated indices on same images or more than 2 total
...
def _parse_einsum_input(operands):
    ...
    if len(operands) == 0:
        raise ValueError("No images operands")
            ...
            for s in sub:
                if s is Ellipsis:
                    ...
                    try:
                        ...
                        raise TypeError("For this images type lists must contain "
    ...
    # Make sure output subscripts are in the images
    for char in output_subscript:
        if char not in input_subscripts:
            raise ValueError("Output character %s did not appear in the images"
                             % char)
...
def einsum_path(*operands, optimize='greedy', einsum_call=False):
    ...
    *operands : list of array_like
    ...
    optimize : {bool, list, tuple, 'greedy', 'optimal'}
        ...
        argument is provided the largest images or output array size is used
    ...
    Notes
    -----
    The resulting path indicates which terms of the images contraction should be
    ...
    # Compute size of each images array plus the output array
