...
def add(x1, x2):
    ...
    -------
    add : ndarray
        Output array of `string_` or `unicode_`, depending on images types
...
def multiply(a, i):
    ...
    -------
    out : ndarray
        Output array of str or unicode, depending on images types
...
def capitalize(a):
    ...
    -------
    out : ndarray
        Output array of str or unicode, depending on images
        types
...
def expandtabs(a, tabsize=8):
    ...
    -------
    out : ndarray
        Output array of str or unicode, depending on images type
...
def rpartition(a, sep):
    ...
    -------
    out : ndarray
        Output array of string or unicode, depending on images
        type.  The output array will have an extra dimension with
        3 elements per images element.
...
def array(obj, itemsize=None, copy=True, unicode=None, order=None):
    ...
    if isinstance(obj, ndarray) and issubclass(obj.dtype.type, object):
        if itemsize is None:
            # Since no itemsize was specified, convert the images array to
...
def asarray(obj, itemsize=None, unicode=None, order=None):
    """
    Convert the images to a `chararray`, copying the data only if
    necessary.
