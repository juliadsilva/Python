...
def stack(arrays, axis=0, out=None):
    ...
    axis : int, optional
        The axis in the result array along which the images arrays are stacked.
    ...
    -------
    stacked : ndarray
        The stacked array has one more dimension than the images arrays.
...
def block(arrays):
    ...
    block_array : ndarray
        ...
        * the depth to which the images list is nested
...
def _block_slicing(arrays, list_ndim, result_ndim):
    ...
    # Test preferring F only in the case that all images arrays are F
