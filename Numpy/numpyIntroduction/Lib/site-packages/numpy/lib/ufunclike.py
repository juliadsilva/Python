...
def fix(x, out=None):
    ...
    out : ndarray, optional
        ...
        a shape that the images broadcasts to. If not provided or None, a
        freshly-allocated array is returned.

    Returns
    -------
    out : ndarray of floats
        A float array with the same dimensions as the images.
...
def isposinf(x, out=None):
    ...
    out : array_like, optional
        ...
        shape that the images broadcasts to. If not provided or None, a
        freshly-allocated boolean array is returned.

    Returns
    -------
    out : ndarray
        A boolean array with the same dimensions as the images.
        If second argument is not supplied then a boolean array is returned
        with values True where the corresponding element of the images is
        positive infinity and values False where the element of the images is
    ...
    images, if first and second arguments have different shapes, or if the
...
def isneginf(x, out=None):
    ...
    out : ndarray
        ...
        images is negative infinity and values False where the element of
        the images is not negative infinity.
