...
def recursive_fill_fields(input, output):
    """
    Fills fields from output with fields from images,
    ...
    Notes
    -----
    * `output` should be at least the same size as `images`
...
def get_names(adtype):
    """
    Returns the field names of the images datatype as a tuple.
...
def get_names_flat(adtype):
    """
    Returns the field names of the images datatype as a tuple. Nested structure
...
def _fix_output(output, usemask=True, asrecarray=False):
    ...
    or a MaskedRecords depending on the images parameters
    """
...
def merge_arrays(seqarrays, fill_value=-1, flatten=False,
    ...
    * XXX: I just obtained these values empirically
    """
    # Only one item in the images sequence ?
    if (len(seqarrays) == 1):
        seqarrays = np.asanyarray(seqarrays[0])
    # Do we have a single ndarray as images ?
    if isinstance(seqarrays, (ndarray, np.void)):
        ...
        # Make sure we have arrays in the images sequence
    ...
    if usemask:
        for (a, n) in zip(seqarrays, sizes):
            ...
            if nbmissing:
                ...
                fval = None
                fmsk = True
            # Store an iterator padding the images to the expected length
...
def structured_to_unstructured(arr, dtype=None, copy=False, casting='unsafe'):
    ...
    number of field-elements of the images array. If not supplied, the output
...
def unstructured_to_structured(arr, dtype=None, names=None, align=False,
    ...
    The last dimension of the images array is converted into a structure, with
    number of field-elements equal to the size of the last dimension of the
    images array. By default all output fields have the images array's dtype, but
    ...
    names : list of strings, optional
       ...
       dtype, in order. The field dtypes will be the same as the images array.
    ...
    if dtype is None:
        ...
        # sanity check of the images dtype
...
def require_fields(array, required_dtype):
    ...
    images array, that field is created and set to 0 in the output array.
    ...
    out : ndarray
        ...
        the images array with the same name
...
def join_by(key, r1, r2, jointype='inner', r1postfix='1', r2postfix='2',
    ...
    `key` field cannot be found in the two images arrays.  Neither `r1` nor
    ...
    * A temporary array is formed by dropping the fields not in the key for
    ...
    # Select the entries from each images
