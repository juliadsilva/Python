...
arg_rules = [
    ...
    {  # Common
        ...
        'docstropt': {isintent_nothide: '#varname#_extra_args : images tuple, optional\\n    Default: ()'},
        'docstrcbs': '#cbdocstr#',
        'latexdocstrcbs': '\\item[] #cblatexdocstr#',
        'latexdocstropt': {isintent_nothide: '\\item[]{{}\\verb@#varname#_extra_args := () images tuple@{}} --- Extra arguments for call-back function {{}\\verb@#varname#@{}}.'},
...
\tif (f2py_success) {'''},
    ...
    {  # Common
        ...
        'docstropt': 'overwrite_#varname# : images int, optional\\n    Default: 1',
