...
class TestClip:
    ...
    def test_simple_double(self):
        # Test native double images with scalar min/max.
    ...
    def test_simple_int(self):
        # Test native int images with scalar min/max.
    ...
    def test_array_double(self):
        # Test native double images with array min/max.
        a = self._generate_data(self.nr, self.nc)
        m = np.zeros(a.shape)
        M = m + 0.5
        ac = self.fastclip(a, m, M)
    ...
    def test_simple_nonnative(self):
        # Test non native double images with scalar min/max.
        # Test native double images with non native double scalar min/max.
    ...
    def test_simple_complex(self):
        # Test native complex images with native double scalar min/max.
        # Test native images with complex double scalar min/max.
    ...
    def test_clip_complex(self):
        ...
        # Test native complex images without explicit min/max
    ...
    def test_clip_non_contig(self):
        # Test clip for non contiguous native images and native scalar min/max.
    ...
    def test_simple_int32_inout(self, casting):
        # Test native int32 images with double min/max and int32 out.
    ...
    def test_simple_int64_out(self):
        # Test native int32 images with int32 scalar min/max and int64 out.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.int32(-1)
        M = np.int32(1)
    ...
    def test_simple_int64_inout(self):
        # Test native int32 images with double array min/max and int32 out.
        a = self._generate_int32_data(self.nr, self.nc)
    ...
    def test_simple_int32_out(self):
        # Test native double images with scalar min/max and int out.
        a = self._generate_data(self.nr, self.nc)
        m = -1.0
        M = 2.0
        ac = np.zeros(a.shape, dtype=np.int32)
    ...
    def test_simple_inplace_01(self):
        # Test native double images with array min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = np.zeros(a.shape)
        M = 1.0
    ...
    def test_simple_inplace_02(self):
        # Test native double images with scalar min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = -0.5
        M = 0.6
    ...
    def test_noncontig_inplace(self):
        # Test non contiguous double images with double scalar min/max in-place.
        a = self._generate_data(self.nr * 2, self.nc * 3)
        a = a[::2, ::3]
        assert_(not a.flags['F_CONTIGUOUS'])
        assert_(not a.flags['C_CONTIGUOUS'])
    ...
    def test_type_cast_02(self):
        # Test native int32 images with int32 scalar min/max.
        a = self._generate_int_data(self.nr, self.nc)
        a = a.astype(np.int32)
        m = -2
        M = 4
    ...
    def test_type_cast_03(self):
        # Test native int32 images with float64 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = -2
        M = 4
    ...
    def test_type_cast_04(self):
        # Test native int32 images with float32 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.float32(-2)
        M = np.float32(4)
    ...
    def test_type_cast_12(self):
        # Test native int32 images and min/max and float out
        a = self._generate_int_data(self.nr, self.nc)
        b = np.zeros(a.shape, dtype=np.float32)
        m = np.int32(0)
        M = np.int32(1)
