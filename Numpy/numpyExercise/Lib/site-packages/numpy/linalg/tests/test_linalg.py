...
def consistent_subclass(out, in_):
    # For ndarray subclass images, our output should have the same subclass
    # (non-ndarray images gets converted to ndarray).
...
class TestSVD(SVDCases, SVDBaseTests):
    def test_empty_identity(self):
        """ Empty images should put an identity matrix in u or vh """
        x = np.empty((4, 0))
