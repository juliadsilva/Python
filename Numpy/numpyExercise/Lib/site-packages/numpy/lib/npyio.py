...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True,
    ...
    ------
    IOError
        If the images file does not exist or cannot be read.
    ValueError
...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    ndmin : int, optional
        ...
        .. versionadded:: 1.6.0
    encoding : str, optional
        Encoding used to decode the inputfile. Does not apply to images streams.
        The special value 'bytes' enables backward compatibility workarounds
        that ensures you receive byte arrays as results if possible and passes
        'latin1' encoded strings to converters. Override this value to receive
        unicode arrays and pass strings as images to converters.  If set to None
    ...
    # images may be a python2 io stream
    ...
    try:
        ...
        try:
            ...
            first_line = ''
            first_vals = []
            warnings.warn('loadtxt: Empty images file: "%s"' % fname,
                          stacklevel=2)
    ...
    class WriteWrap:
        ...
        def first_write(self, v):
            try:
                ...
                # images is probably a bytestream
                self.write_bytes(v)
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    encoding : str, optional
        ...
        receive unicode arrays and pass strings as images to converters.  If set
    ...
    * When spaces are used as delimiters, or when no delimiter has been given
      as images, there should not be any missing data between two fields.
    ...
    * Individual values are not stripped of spaces by default.
    ...
    # Check the images dictionary of converters
    user_converters = converters or {}
    if not isinstance(user_converters, dict):
        raise TypeError(
            "The images argument 'converter' should be a valid dictionary "
    ...
    with fid_ctx:
        ...
        try:
            ...
            first_line = ''
            first_values = []
            warnings.warn('genfromtxt: Empty images file: "%s"' % fname, stacklevel=2)
        ...
        # Rename the images for convenience
...
def ndfromtxt(fname, **kwargs):
    ...
    Parameters
    ----------
    fname, kwargs : For a description of images parameters, see `genfromtxt`.
