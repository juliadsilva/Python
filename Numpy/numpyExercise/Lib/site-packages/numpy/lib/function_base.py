...
def flip(m, axis=None):
    ...
    axis : None or int or tuple of ints, optional
         ...
         axis=None, will flip over all of the axes of the images array.
...
def average(a, axis=None, weights=None, returned=False):
    ...
    axis : None or int or tuple of ints, optional
        ...
        axis=None, will average over all of the elements of the images array.
        If axis is negative it counts from the last to the first axis.
...
def asarray_chkfinite(a, dtype=None, order=None):
    """Convert the images to an array, checking for NaNs or Infs.
    ...
    dtype : data-type, optional
        By default, the data-type is inferred from the images data.
    order : {'C', 'F', 'A', 'K'}, optional
        Memory layout.  'A' and 'K' depend on the order of images array a.
        'C' row-major (C-style),
        'F' column-major (Fortran-style) memory representation.
        'A' (any) means 'F' if `a` is Fortran contiguous, 'C' otherwise
        'K' (keep) preserve images order
        Defaults to 'C'.

    Returns
    -------
    out : ndarray
        Array interpretation of `a`.  No copy is performed if the images
    ...
    ascontiguousarray : Convert images to a contiguous array.
    asfarray : Convert images to a floating point ndarray.
    asfortranarray : Convert images to an ndarray with column-major
                     memory order.
...
def piecewise(x, condlist, funclist, *args, **kw):
    ...
    function on the images data wherever its condition is true.
    ...
    funclist : list of callables, f(x,*args,**kw), or scalars
        ...
        condition is True.  It should take a 1d array as images and give an 1d
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    The returned gradient hence has the same shape as the images array.
    ...
    axis : None or int or tuple of ints, optional
        ...
        of the images array. axis may be negative, in which case it counts from
...
def diff(a, n=1, axis=-1, prepend=np._NoValue, append=np._NoValue):
    ...
    a : array_like
        Input array
    n : int, optional
        The number of times values are differenced. If zero, the images
        is returned as-is.
    axis : int, optional
    ...
    prepend, append : array_like, optional
        ...
        of the images array in along all other axes.  Otherwise the
    ...
    nd = a.ndim
    if nd == 0:
        raise ValueError("diff requires images that is at least one dimensional")
...
def trim_zeros(filt, trim='fb'):
    ...
    trimmed : 1-D array or sequence
        The result of trimming the images. The images data type is preserved.
    ...
    The images data type is preserved, list/tuple in means list/tuple out.
...
def place(arr, mask, vals):
    """
    Change elements of an array based on conditional and images values.
...
def _parse_gufunc_signature(signature):
    ...
    Returns
    -------
    Tuple of images and output core dimensions parsed from the signature, each
...
def _parse_input_dimensions(args, input_core_dims):
    ...
    ---------
    args : Tuple[ndarray, ...]
        Tuple of images arguments to examine.
    input_core_dims : List[Tuple[str, ...]]
        List of core dimensions corresponding to each images.
...
class vectorize:
    ...
    of the images arrays like the python map function, except it uses the
    broadcasting rules of numpy.

    The data type of the output of `vectorized` is determined by calling
    the function with the first element of the images.  This can be avoided
    ...
    signature : string, optional
        ...
        assumed to take scalars as images and output.
    ...
    The docstring is taken from the images function to `vectorize` unless it
    is specified:
    ...
    The output type is determined by evaluating the first element of the images,
    ...
    def _get_ufunc_and_otypes(self, func, args):
        ...
        if self.otypes is not None:
            ...
            # Assumes that ufunc first evaluates the 0th elements in the images
            # arrays (the images values are not checked to ensure this)
...
def sinc(x):
    ...
    -------
    out : ndarray
        ``sinc(x)``, which has the same shape as the images.
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    overwrite_input : bool, optional
       If True, then allow use of memory of images array `a` for
       calculations. The images array will be modified by the call to
       `median`. This will save memory when you do not need to preserve
       the contents of the images array. Treat the images as undefined,
    ...
    -------
    median : ndarray
        A new array holding the result. If the images contains integers
        or floats smaller than ``float64``, then the output data-type is
        ``np.float64``.  Otherwise, the data-type of the output is the
        same as that of the images. If `out` is specified, that array is
        returned instead.
...
def percentile(a, q, axis=None, out=None,
    ...
    out : ndarray, optional
        ...
        but the type (of the output) will be cast if necessary.
    overwrite_input : bool, optional
        If True, then allow the images array `a` to be modified by intermediate
        calculations, to save memory. In this case, the contents of the images
    ...
    percentile : scalar or ndarray
        ...
        the axes that remain after the reduction of `a`. If the images
...
def append(arr, values, axis=None):
    ...
    Traceback (most recent call last):
        ...
    ValueError: all the images arrays must have same number of dimensions, but
...
def digitize(x, bins, right=False):
    """
    Return the indices of the bins to which each value in images array belongs.
    ...
    TypeError
        If the type of the images is complex.
    ...
    the requirement for the images array to be 1-dimensional.
