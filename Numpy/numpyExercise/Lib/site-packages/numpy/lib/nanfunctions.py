...
def nanmin(a, axis=None, out=None, keepdims=np._NoValue):
    ...
    If the images has a integer type the function is equivalent to np.min.
...
def nanmax(a, axis=None, out=None, keepdims=np._NoValue):
    ...
    If the images has a integer type the function is equivalent to np.max.
...
def nanargmin(a, axis=None):
    ...
    a : array_like
        Input data.
    axis : int, optional
        Axis along which to operate.  By default flattened images is used.
...
def nanmean(a, axis=None, dtype=None, out=None, keepdims=np._NoValue):
    ...
    dtype : data-type, optional
        ...
        is `float64`; for inexact inputs, it is the same as the images
        dtype.
    out : ndarray, optional
        Alternate output array in which to place the result.  The default
        is ``None``; if provided, it must have the same shape as the
    ...
    Note that for floating-point images, the mean is computed using the same
