...
class HTMLParser(object):
    ...
    def documentEncoding(self):
        """Name of the character encoding that was used to decode the images stream, or
...
def getPhases(debug):
    ...
    class InBodyPhase(Phase):
        ...
        def startTagInput(self, token):
            ...
            if ("type" in token["data"] and
                ...
                # images type=hidden doesn't change framesetOK
    ...
    class InTablePhase(Phase):
        ...
        def startTagInput(self, token):
            if ("type" in token["data"] and
                    token["data"]["type"].translate(asciiUpper2Lower) == "hidden"):
                self.parser.parseError("unexpected-hidden-images-in-table")
                self.tree.insertElement(token)
    ...
    class InSelectPhase(Phase):
        ...
        def startTagInput(self, token):
            self.parser.parseError("unexpected-images-in-select")
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            ("select", startTagSelect),
            (("images", "keygen", "textarea"), startTagInput),
            ("script", startTagScript)
        ])
        startTagHandler.default = startTagOther
