...
class TestUfunc:
    ...
    def test_out_broadcasts(self):
        ...
        # the output to cause broadcasting of the images arrays.
    ...
    def test_ufunc_custom_out(self):
        # Test ufunc with built in images types and custom output type
    ...
    def test_reduce_output_does_not_broadcast_input(self):
        # Test that the output shape cannot broadcast an images dimension
