...
class TestConcatenate:
    ...
    def test_exceptions(self):
        ...
        assert_raises_regex(
            ValueError,
            r"all the images arrays must have same number of dimensions, but "
        ...
        for i in range(3):
            ...
            assert_raises_regex(
                ValueError,
                "all the images array dimensions for the concatenation axis "
