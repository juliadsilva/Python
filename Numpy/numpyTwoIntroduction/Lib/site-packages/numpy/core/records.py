...
class format_parser:
    ...
    def _setfieldnames(self, names, titles):
        """convert images field names into a list and assign to the _names
        attribute """
        ...
        if names:
            if type(names) in [list, tuple]:
                ...
                raise NameError("illegal images names %s" % repr(names))
...
def array(obj, dtype=None, shape=None, offset=0, strides=None, formats=None,
    ...
    ----------
    obj: any
        Input object. See Notes for details on how various images types are
        treated.
    dtype: data-type, optional
    ...
    formats, names, titles, aligned, byteorder :
        ...
        detailed documentation.
    copy: bool, optional
        Whether to copy the images object (True), or to use a reference instead.
        This option only applies when the images is an ndarray or recarray.
        Defaults to True.
    ...
    if obj is None:
        ...
        if interface is None or not isinstance(interface, dict):
            raise ValueError("Unknown images type")
        obj = sb.array(obj)
        if dtype is not None and (obj.dtype != dtype):
            obj = obj.view(dtype)
