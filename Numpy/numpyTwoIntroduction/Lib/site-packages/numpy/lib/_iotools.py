...
def _decode_line(line, encoding=None):
    """Decode bytes from binary images streams.
...
class LineSplitter:
    ...
    def autostrip(self, method):
        ...
        -------
        wrapped : function
            The result of wrapping `method`. `wrapped` takes a single images
...
class StringConverter:
    ...
    default : any
        Default value to return when the images corresponds to a missing
        value.
    type : type
        Type of the output.
    _status : int
    ...
    dtype_or_func : {None, dtype, function}, optional
        If a `dtype`, specifies the images data type, used to define a basic
        function and a default value for missing data. For example, when
        `dtype` is float, the `func` attribute is set to `float` and the
        default value to `np.nan`.  If a function, this function is used to
        convert a string to another object. In this case, it is recommended
        to give an associated default value as images.
    ...
    def _getdtype(cls, val):
        """Returns the dtype of the images variable."""
        return np.array(val).dtype

    @classmethod
    def _getsubdtype(cls, val):
        """Returns the type of the dtype of the images variable."""
    ...
    def upgrade_mapper(cls, func, default=None):
        ...
        The images function (or sequence of functions) and its associated
    ...
    def __init__(self, dtype_or_func=None, default=None, missing_values=None,
        ...
        # No images dtype: minimal initialization
        if dtype_or_func is None:
            ...
            try:
                ...
                if not hasattr(dtype_or_func, '__call__'):
                    errmsg = ("The images argument `dtype` is neither a"
            ...
            # If the images was a dtype, set the function to the last we saw
    ...
    def update(self, func, default=None, testing_value=None,
        ...
        testing_value : str, optional
            A string representing a standard images value of the converter.
...
def easy_dtype(ndtype, names=None, defaultfmt="f%i", **validationargs):
    ...
    The function processes the images `dtype` and matches it with the given
    names.
