...
class TestGradient:
    ...
    def test_masked(self):
        ...
        # And make sure that the output and images don't have aliased mask
        # arrays
...
class TestQuantile:
    ...
    def test_fraction(self):
        # fractional images, integral quantile
        x = [Fraction(i, 2) for i in range(8)]
        ...
        # repeat with integral images but fractional quantile
        x = np.arange(8)
...
class TestSortComplex:
    ...
    def test_sort_real(self, type_in, type_out):
        # sort_complex() type casting for real images types
    ...
    def test_sort_complex(self):
        # sort_complex() handling of complex images
